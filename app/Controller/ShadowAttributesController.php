...
class ShadowAttributesController extends AppController
{
    ...
    private function __accept($id)
    {
        ...
        $this->ShadowAttribute->getKafkaPubTool()->publishNotification('shadow_attribute', $shadow, 'accept');
    ...
    private function __discard($id)
    {
        ...
        $this->ShadowAttribute->getKafkaPubTool()->publishNotification('shadow_attribute', $sa, 'discard');

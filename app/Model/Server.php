    ...
    public function __construct($id = false, $table = null, $ds = null)
    {
        ...
        $this->serverSettings = array(
                ...
                'Plugin' => array(
                        ...
                        'ActiveMQ_uri' => array(
                            'level' => 2,
                            'description' => __('URI of the ActiveMQ broker'),
                            'value' => 'ssl://activemq:61612',
                            'errorMessage' => '',
                            'test' => 'testForEmpty',
                            'type' => 'string',
                        ),
                        'ActiveMQ_username' => array(
                            'level' => 2,
                            'description' => __('Username for the ActiveMQ broker'),
                            'value' => 'admin',
                            'errorMessage' => '',
                            'test' => 'testForEmpty',
                            'type' => 'string',
                        ),
                        'ActiveMQ_password' => array(
                            'level' => 2,
                            'description' => __('Password for the ActiveMQ broker'),
                            'value' => 'admin',
                            'errorMessage' => '',
                            'test' => 'testForEmpty',
                            'type' => 'string',
                        ),
                        'ActiveMQ_topic' => array(
                            'level' => 2,
                            'description' => __('Topic for publishing on the ActiveMQ broker'),
                            'value' => '/queue/test',
                            'errorMessage' => '',
                            'test' => 'testForEmpty',
                            'type' => 'string',
